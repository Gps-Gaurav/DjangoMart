...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'gpshacker321@gmail.com'  # Update with your email
EMAIL_HOST_PASSWORD = 'ygbdwljgvaovnevg'  # Update with your app password
...
CURRENT_TIME_UTC = datetime.now(pytz.UTC).strftime('%Y-%m-%d %H:%M:%S')
